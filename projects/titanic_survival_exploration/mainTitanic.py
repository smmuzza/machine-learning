...
predictions = pd.Series(np.ones(5, dtype = int)) # grab the first 5 predictions
print(accuracy_score(outcomes[:5], predictions)) # only do the first 5 outcomes
...
print(accuracy_score(outcomes, predictions)) # this time check all teh data not just 5
